 ...
 */
final class Version20200426070527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, from_user_id INT DEFAULT NULL, conversation_id INT DEFAULT NULL, content VARCHAR(1000) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_B6BD307F2130303A (from_user_id), INDEX IDX_B6BD307F9AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
